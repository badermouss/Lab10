...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        # row 2
        self._ddCountries = ft.Dropdown(label="Seleziona uno stato", on_change=self._controller.read_country)
        self._btnConnesse = ft.ElevatedButton(text="Stati Raggiungibili", on_click=self._controller.handleRaggiungibili, disabled=True)
        self._controller.fillDD()
        row2 = ft.Row([self._ddCountries, self._btnConnesse], alignment=ft.MainAxisAlignment.CENTER)
